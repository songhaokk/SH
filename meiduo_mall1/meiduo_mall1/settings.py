"""
Django settings for meiduo_mall1 project.
...
SECRET_KEY = 'kj78y9ate!(7zi6i49_8l%911(yw0siv-#9@f@=xf1+&9ez@&d'
...
ROOT_URLCONF = 'meiduo_mall1.urls'
...
WSGI_APPLICATION = 'meiduo_mall1.wsgi.application'
